...
public class RmiServer extends UnicastRemoteObject implements ServerInterface {
    ...
    private static ArrayList<ClientInterface> users;
    ...
    public synchronized boolean insertUserPrivilege(String username) throws RemoteException, InterruptedException {
        ...
        if (message_from_multicast.equals("type|insert_user_privilege;status|on") || message_from_multicast.equals("type|insert_user_privilege;status|off")) {
            ...
            if (status.equals("on")) {
                ...
                for(ClientInterface client: users){
                    System.out.println(client.getMy_username());
                    if(client.getMy_username().equals(username)){
                        client.notifyPrivileges();
                    }
                }
            }
     ...
     * @return
     */
    public synchronized boolean insertAlbum(String album_name, String album_record_label, String artist_name,String client) {
        boolean flag_insert_album = false;

        String message_to_multicast = "type|insert_album;album_name|" + album_name + ";album_record_label|" + album_record_label + ";artist_name|" + artist_name+";username|"+client;
        String message_from_multicast = sendPacket(message_to_multicast);
     ...
     * @throws RemoteException
     */
    public synchronized boolean editAlbum(String album_to_edit, String album_name, String album_record_label, String artist_name,String username) throws RemoteException {
        ...
        String message_to_multicast = "type|edit_album;album_to_edit|" + album_to_edit + ";album_name|" + album_name + ";album_record_label|" + album_record_label + ";artist_name|" + artist_name+";username|"+username;
        String message_from_multicast = sendPacket(message_to_multicast);
        ...
        if (message_from_multicast.equals("type|edit_album;status|on") || message_from_multicast.equals("type|edit_album;status|off")) {
            ...
            if (status.equals("on")) {
                ...
                for(ClientInterface client: users){
                    if(users_list.contains(client.getMy_username())){
                        client.notifyTextualDescription();
                    }
                }
            }
        }
    ...
    public synchronized ArrayList<String> detailsArtist(String artist_name) {
        ...
        String message_to_multicast = "type|details_artist;username|" + artist_name;
        String raw = sendPacket(message_to_multicast);
     ...
     * @return
     */
    public synchronized boolean deleteClient(ClientInterface client){
