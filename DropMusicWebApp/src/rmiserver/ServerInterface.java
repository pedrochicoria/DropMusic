...
public interface ServerInterface extends Remote {
    ...
    String createservice() throws RemoteException;

    String loginService() throws RemoteException;

    String loginDropbox(String code) throws RemoteException;

    boolean dropboxAssociation(String username, String code) throws RemoteException;
     ...
     */
    void webRegisterForCallback(WebSocketInterface websocket) throws RemoteException;
    /**
    ...
    String getAlbumRating(String album) throws RemoteException;
    /**
     ...
     * @throws RemoteException
     */
    boolean insertAlbum(String album_name, String album_record_label, String artist_name) throws RemoteException;
     ...
     * @throws RemoteException
     */
    boolean editAlbum(String album_to_edit, String album_name, String album_record_label, String artist_name) throws RemoteException;
