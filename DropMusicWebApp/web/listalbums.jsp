...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%; color: dimgrey" align="center">
        ...
        <table >
            ...
            <c:forEach items="${albumBean.listAlbums}" var="album">
                <tr>
                    <c:forEach items ="${album}" var="value">
                        <td>
                            <c:out value="${value}" />
                        </td>
                    </c:forEach>
        ...
        <s:form action="detailsofalbum" method="post" theme="simple">
            <h2>Consult Details of Album</h2>
            <br>
            <h4 style="color: dimgrey">Artist:</h4> <s:textfield name="albumBean.artist" label="Artist"/>
            <br><br>
            <h4 style="color: dimgrey">Album:</h4> <s:textfield name="albumBean.albumname" label="Album"/>
            <br><br>
