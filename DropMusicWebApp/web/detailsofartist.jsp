...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%; color: dimgrey" align="center">
        <h2 style="color: dimgrey">Details of Artist</h2>
        <table >

            <tr>

                <td>Name</td>
                <td><c:out value="${artistBean.detailsOfArtist.artist_name}"/></td>
            </tr>
            <tr>
                <td>Age</td>
                <td><c:out value="${artistBean.detailsOfArtist.age}"/></td>
            </tr>
            <tr>
                <td>Music Style</td>
                <td><c:out value="${artistBean.detailsOfArtist.music_style}"/></td>
            </tr>
            <tr>
                <td>Biography</td>
                <td><c:out value="${artistBean.detailsOfArtist.biography}"/></td>
            </tr>

        </table>
        <h2 style="color: dimgrey">Discography of Artist</h2>
        ...
        <table >
            ...
            <c:forEach items="${artistBean.albumsbyArtist}" var="value">
                <tr>
                    <td>
                        <c:out value="${value}" />
                    </td>
