...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%; color: dimgrey" align="center">
        <h2 style="color: dimgrey">Details of Music</h2>
        <table >
            <tr>
                <td>Artist</td>
                <td><c:out value="${musicBean.artist}"/></td>
            </tr>
            <tr>
                <td>Album</td>
                <td><c:out value="${musicBean.album}"/></td>
            </tr>
            <tr>
                <td>Music Name</td>
                <td><c:out value="${musicBean.detailsOfMusic.music_name}"/></td>
            </tr>
            <tr>
                <td>Musical Gender</td>
                <td><c:out value="${musicBean.detailsOfMusic.musical_gender}"/></td>
            </tr>
            <tr>
                <td>Lyrisc</td>
                <td><c:out value="${musicBean.detailsOfMusic.lyrics}"/></td>
            </tr>
            <tr>
                <td>Composer</td>
                <td><c:out value="${musicBean.detailsOfMusic.composer}"/></td>
            </tr>
            <tr>
                <td>Release Date</td>
                <td><c:out value="${musicBean.detailsOfMusic.realease_date}"/></td>
            </tr>
    ...
    <s:form action = "associatefilemusic" method="POST" theme="simple">
