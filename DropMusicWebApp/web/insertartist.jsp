...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%; color: dimgrey" align="center">
        ...
        <s:form action="createartist" method="post" theme="simple">

            <h4 style="color: dimgrey">Name:</h4> <s:textfield name="artistBean.name" label="Name"/>
            <br><br>
            <h4 style="color: dimgrey">Age:</h4> <s:textfield name="artistBean.age" label="Age"/>
            <br><br>
            <h4 style="color: dimgrey">Music Style:</h4> <s:textfield name="artistBean.musicstyle" label="Music Style"/>
            <br><br>
            <h4 style="color: dimgrey">Biography:</h4> <s:textfield name="artistBean.biography" label="Biography" />
            <br><br>
            <s:submit type="button" label="Create Artist" cssClass="registerbtn"/>
