...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%; color: dimgrey" align="center">
        <h2 style="color:dimgrey">Remove Music</h2><br>
        <s:form action="removemusic" method="post" theme="simple">
            ...
            <s:submit type="button" label="Delete Music" cssClass="registerbtn"/>
