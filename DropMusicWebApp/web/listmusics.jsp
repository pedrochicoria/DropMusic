...
<div class="container">
    <div id="left" style="float:left; width:100%; color: dimgrey" align="center">
        <table >
            ...
            <c:forEach items="${musicBean.listMusics}" var="value">
                <tr>
                    <td>
                        <c:out value="${value}" />
                    </td>
        ...
        <s:form action="detailsofmusic" method="post" theme="simple">
            <h2>Consult Details of Music</h2>
            <br>
            <h4 style="color: dimgrey">Artist:</h4> <s:textfield name="musicBean.artist" label="Artist"/>
            <br><br>
            <h4 style="color: dimgrey">Album:</h4> <s:textfield name="musicBean.album" label="Album"/>
            <br><br>
            <h4 style="color: dimgrey">Music:</h4> <s:textfield name="musicBean.musicname" label="Music"/>
            <br><br>
