...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%; color: dimgrey" align="center">
        <h2 style="color:dimgrey">Grant privileges</h2><br>
        <s:form action="grantprivileges" method="post" theme="simple">

            <h4 style="color: dimgrey">Name:</h4> <s:textfield name="userBean.username" label="Name"/>
            <br><br>

            <s:submit type="button" label="Grant Privilege" cssClass="registerbtn"/>
