...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%; color: dimgrey" align="center">
        <h2 style="color:dimgrey">Change Album</h2><br>
        <s:form action="changealbum" method="post" theme="simple">
            ...
            <br><br>
            <h4 style="color: dimgrey">New Album Name:</h4> <s:textfield name="albumBean.newalbum" label="New Album Name"/>
            <br><br>
            <h4 style="color: dimgrey">New Record Label:</h4> <s:textfield name="albumBean.recordlabel" label="New Record Label"/>
            <br><br>
            <s:submit type="button" label="Change Album" cssClass="registerbtn"/>
