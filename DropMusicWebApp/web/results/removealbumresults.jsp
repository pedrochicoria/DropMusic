...
<html>
<head>
    <title>Remove Album Result</title>
    <meta charset="utf-8">
...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%; color: dimgrey" align="center">
        <h2 style="color:dimgrey">Remove Album</h2><br>
        <c:choose>
            <c:when test="${albumBean.deleteAlbum == true}">
                <h2 style="color: dimgrey;text-align: center">Album is deleted</h2>
            </c:when>
        </c:choose>
    </div>
</div>
