...
<html>
<head>
    <title>Insert Review Result</title>
    <meta charset="utf-8">
...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%; color: dimgrey" align="center">
        <h2 style="color:dimgrey">Write Review </h2><br>
        <c:choose>
            <c:when test="${albumBean.writeReview== true}">
                <h2 style="color: dimgrey;text-align: center">Review is inserted</h2>
            </c:when>
        </c:choose>
    </div>
</div>
